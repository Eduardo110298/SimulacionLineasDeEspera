 ...
 */
package org.system.constants.constantes;

/*
    Clase donde se definen las constantes globales del Sistema
*/
public class ConstantesGlobales {
    ...
    public static final double _Patron_Servicio_Alpha = 0.360401;
    
    public static final int _Digitos_Random = 3;
    
    public static final int _Digitos_Resultados = 2;
